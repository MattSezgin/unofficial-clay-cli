...
function main() {
  ...
  if (!file || flags.help) {
    console.log('Usage: node lib/profile-context.js <config.yaml|json> [--profile default] [--require-resolved] [--require-pinned-scope] [--workspace ID] [--folder ID] [--workbook ID] [--env KEY=VALUE] [--out context.json]');
    return;
  }
