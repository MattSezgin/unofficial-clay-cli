...
function main() {
  ...
  if (!file || flags.help) {
    console.log('Usage: node lib/validate-config.js <config.yaml|json> [--profile default] [--require-resolved] [--require-pinned-scope] [--workspace ID] [--folder ID] [--workbook ID] [--env KEY=VALUE]');
    return;
  }
