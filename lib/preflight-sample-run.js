...
function main() {
  ...
  if (!file || flags.help) {
    console.log('Usage: node lib/preflight-sample-run.js <sample-run.json|yaml> [--config config.yaml --profile NAME] [--workspace WORKSPACE_ID] [--folder FOLDER_ID] [--workbook WORKBOOK_ID] [--out preflight.json]');
    return;
  }
