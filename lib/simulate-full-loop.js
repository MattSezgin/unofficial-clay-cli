...
function main() {
  ...
  if (flags.help) {
    console.log('Usage: node lib/simulate-full-loop.js --request "Build a campaign personalization table" --inputs examples/outbound-personalization-input.example.yaml --config config.example.yaml --profile yourTestProfile [--out-dir runs/<date>/simulation] [--json]');
    return;
  }
