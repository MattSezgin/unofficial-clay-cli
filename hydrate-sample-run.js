...
function main() {
  ...
  if (!file || flags.help) {
    console.log('Usage: node hydrate-sample-run.js <sample-run.json|yaml> [--apply-result apply.json] [--table TABLE_ID --view VIEW_ID] [--completed apply_sample_spec] [--out hydrated.json]');
    return;
  }
