...
function main() {
  ...
  if (flags.help || !flags.evidence) {
    console.log('Usage: node scale-gate.js --evidence evidence.json --workbook-parity parity.json --plan plan.json --command "node clay-v2.js run-top ... --confirm|--dev-mode" --quality-reviewed true [--out scale-gate.json]');
    return;
  }
