...
const before = readCatalog(path.join(__dirname, 'fixtures/fixtures/catalog-delta-before.json'));
const after = readCatalog(path.join(__dirname, 'fixtures/fixtures/catalog-delta-after.json'));
