...
const { buildProofPacketFromManifest, suggestExtractedOutputPaths, valueMatchesShape, enumValueQaChecks, semanticContradictionChecks, isCompatibleUseAiModelPair, buildSafeModelMatrixProbePlan, validateSafeModelMatrixProbeResult } = require('./proof-harness');
